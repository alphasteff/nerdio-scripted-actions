<#
.DESCRIPTION
Start PSADT install with dynamic values
...
if (Get-Process explorer -ErrorAction SilentlyContinue){
    ...
    Write-Log "DeploymentType = Install"
    Write-Log "DeployMode = Interactive"
    & $PSScriptRoot\ServiceUI.exe -process:explorer.exe $PSScriptRoot\Deploy-Application.exe -DeploymentType Install -DeployMode Interactive
    Write-Log "Command line <$PSScriptRoot\ServiceUI.exe -process:explorer.exe $PSScriptRoot\Deploy-Application.exe -DeploymentType Install -DeployMode Interactive> was run"
}
else{
    ...
    & $PSScriptRoot\Deploy-Application.exe -DeploymentType Install -DeployMode NonInteractive
    Write-Log "Command line <$PSScriptRoot\Deploy-Application.exe -DeploymentType Install -DeployMode NonInteractive> was run"
}
