...
$Fqdn = 'nerdiolab1.com'
$UserOU = 'CN=Users, DC=nerdiolab1, DC=com'
$Password = 'Dubai_12345!!'
...
# Define common password for all users - Ensure to comply with your password policy
...
for ($i = 1; $i -le 50; $i++) {
    ...
    $newUserParams = @{
        ...
        Path                  = $UserOU # Change to the correct OU path
    }
...
If ($createDeploymentResourceGroup) {
    $paramResourceGroup = @{
        ...
        Tags              = $DeploymentResourceGroupTags
...
$avdConfigs | ForEach-Object -Parallel {
    ...
    #New-BesNmeHostPoolUserAssignment @paramHostPool -UserPrincipalName $avdConfig.userPrincipalName
