...
$null = $storageAccounts.add(@{storageAccountName = 'bestest01'; resourceGroupName = 'test01_group'; subscriptionId = '37f76653-992c-450e-a81e-1b5d65870eef'; targetSKU = 'Premium_ZRS' })
