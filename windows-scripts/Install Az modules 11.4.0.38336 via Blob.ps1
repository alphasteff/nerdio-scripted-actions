#name: Install Az modules 11.4.0.38336 via Blob
#description: Installs the required Az modules 11.4.0.38336 via Blob
#execution mode: IndividualWithRestart
#tags: beckmann.ch

<# Notes:

BUse this script to download and install the Azure modules from a storage account. This is required if the Azure modules cannot be updated directly. However, the container must have Blob as authorization, as no authentication can be performed. Ideally, the files can be stored on the Deplyoment storage account.
